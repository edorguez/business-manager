...
func UpdateBusinessPhone(w http.ResponseWriter, r *http.Request, c *config.Config) {
	w.Header().Set("Content-Type", "application/json")
	fmt.Println("API Gateway :  UpdateBusinessPhone")
	...
	fmt.Println("API Gateway :  UpdateBusinessPhone - Body")
	fmt.Println(body)
	fmt.Println("-----------------")
	...
	if errUpdate != nil {
		fmt.Println("API Gateway :  UpdateBusinessPhone - ERROR")
		json.NewEncoder(w).Encode(errUpdate)
		return
	}

	fmt.Println("API Gateway :  UpdateBusinessPhone - SUCCESS")
