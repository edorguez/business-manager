...
const (
	CustomerService_CreateCustomer_FullMethodName       = "/pb.CustomerService/CreateCustomer"
	CustomerService_GetCustomer_FullMethodName          = "/pb.CustomerService/GetCustomer"
	CustomerService_GetCustomers_FullMethodName         = "/pb.CustomerService/GetCustomers"
	CustomerService_GetCustomersByMonths_FullMethodName = "/pb.CustomerService/GetCustomersByMonths"
	CustomerService_UpdateCustomer_FullMethodName       = "/pb.CustomerService/UpdateCustomer"
	CustomerService_DeleteCustomer_FullMethodName       = "/pb.CustomerService/DeleteCustomer"
)
...
func (c *customerServiceClient) GetCustomersByMonths(ctx context.Context, in *GetCustomersByMonthsRequest, opts ...grpc.CallOption) (*GetCustomersByMonthsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_GetCustomersByMonths_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerService_GetCustomersByMonths_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CustomerService_GetCustomersByMonths_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
