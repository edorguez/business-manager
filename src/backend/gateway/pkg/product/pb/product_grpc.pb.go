...
const (
	...
	ProductService_GetLatestProducts_FullMethodName   = "/pb.ProductService/GetLatestProducts"
	ProductService_UpdateProduct_FullMethodName       = "/pb.ProductService/UpdateProduct"
	ProductService_UpdateProductStatus_FullMethodName = "/pb.ProductService/UpdateProductStatus"
...
func (c *productServiceClient) GetLatestProducts(ctx context.Context, in *GetLatestProductsRequest, opts ...grpc.CallOption) (*GetLatestProductsResponse, error) {
	out := new(GetLatestProductsResponse)
	err := c.cc.Invoke(ctx, ProductService_GetLatestProducts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) UpdateProductStatus(ctx context.Context, in *UpdateProductStatusRequest, opts ...grpc.CallOption) (*UpdateProductStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductService_UpdateProductStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_GetLatestProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLatestProductsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).GetLatestProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_GetLatestProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetLatestProducts(ctx, req.(*GetLatestProductsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
