...
func (c *productServiceClient) GetLatestProducts(ctx context.Context, in *GetLatestProductsRequest, opts ...grpc.CallOption) (*GetLatestProductsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ProductService/GetLatestProducts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) UpdateProductStatus(ctx context.Context, in *UpdateProductStatusRequest, opts ...grpc.CallOption) (*UpdateProductStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.ProductService/UpdateProductStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_GetLatestProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ProductService/GetLatestProducts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_UpdateProductStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.ProductService/UpdateProductStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
