...
func file_pkg_product_pb_product_proto_init() {
	...
	file_pkg_product_pb_product_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_pkg_product_pb_product_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_pkg_product_pb_product_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_pkg_product_pb_product_proto_msgTypes[8].OneofWrappers = []interface{}{}
	type x struct{}
