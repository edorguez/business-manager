...
type Querier interface {
	...
	GetPaymentType(ctx context.Context, id int64) (CompanyPaymentType, error)
	GetPaymentTypes(ctx context.Context, arg GetPaymentTypesParams) ([]CompanyPaymentType, error)
