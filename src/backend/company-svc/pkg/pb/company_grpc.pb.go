...
type CompanyServiceClient interface {
	...
	GetCompanys(ctx context.Context, in *GetCompaniesRequest, opts ...grpc.CallOption) (*GetCompaniesResponse, error)
...
func (c *companyServiceClient) GetCompanys(ctx context.Context, in *GetCompaniesRequest, opts ...grpc.CallOption) (*GetCompaniesResponse, error) {
	out := new(GetCompaniesResponse)
	err := c.cc.Invoke(ctx, "/pb.CompanyService/GetCompanys", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompanyServiceServer interface {
	...
	GetCompanys(context.Context, *GetCompaniesRequest) (*GetCompaniesResponse, error)
...
func (UnimplementedCompanyServiceServer) GetCompanys(context.Context, *GetCompaniesRequest) (*GetCompaniesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCompanys not implemented")
}
...
func _CompanyService_GetCompanys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCompaniesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompanyServiceServer).GetCompanys(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.CompanyService/GetCompanys",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompanyServiceServer).GetCompanys(ctx, req.(*GetCompaniesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CompanyService_GetCompanys_Handler,
		},
		{
