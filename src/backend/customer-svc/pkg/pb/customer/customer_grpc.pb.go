...
const (
	...
	CustomerService_GetCustomersByMonths_FullMethodName = "/customer.CustomerService/GetCustomersByMonths"
...
func (c *customerServiceClient) GetCustomersByMonths(ctx context.Context, in *GetCustomersByMonthsRequest, opts ...grpc.CallOption) (*GetCustomersByMonthsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerService_GetCustomersByMonths_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
