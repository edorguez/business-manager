...
type GetCompanyResponse struct {
	...
	IsFreeTrial     bool                   `protobuf:"varint,5,opt,name=isFreeTrial,proto3" json:"isFreeTrial,omitempty"`
	PlanId          int64                  `protobuf:"varint,6,opt,name=plan_id,json=planId,proto3" json:"plan_id,omitempty"`
	LastPaymentDate *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=lastPaymentDate,proto3" json:"lastPaymentDate,omitempty"`
...
func (x *GetCompanyResponse) GetIsFreeTrial() bool {
	if x != nil {
...
const file_company_proto_rawDesc = "" +
	...
	"\bimageUrl\x18\x04 \x01(\tH\x00R\bimageUrl\x88\x01\x01\x12 \n" +
	"\visFreeTrial\x18\x05 \x01(\bR\visFreeTrial\x12\x17\n" +
	"\aplan_id\x18\x06 \x01(\x03R\x06planId\x12D\n" +
	"\x0flastPaymentDate\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0flastPaymentDate\x12\x16\n" +
	"\x06status\x18\b \x01(\x03R\x06status\x12\x14\n" +
	"\x05error\x18\t \x01(\tR\x05errorB\v\n" +
	"\t_imageUrl\"-\n" +
