...
const file_user_proto_rawDesc = "" +
	...
	"\arole_id\x18\x02 \x01(\x03R\x06roleId\x12\x14\n" +
	...
	"\arole_id\x18\x03 \x01(\x03R\x06roleId\x12\x14\n" +
	...
	"\x05users\x18\x01 \x03(\v2\x15.user.GetUserResponseR\x05users\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x03R\x06status\x12\x14\n" +
	"\x05error\x18\x03 \x01(\tR\x05error\"*\n" +
	"\x04Role\x12\x0e\n" +
	...
	"\x13UpdateEmailResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\x03R\x06status\x12\x14\n" +
	...
	"\x06status\x18\x01 \x01(\x03R\x06status\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error2\xd4\x03\n" +
	"\vUserService\x12?\n" +
	"\n" +
	...
	"\vUpdateEmail\x12\x18.user.UpdateEmailRequest\x1a\x19.user.UpdateEmailResponse\x12K\n" +
